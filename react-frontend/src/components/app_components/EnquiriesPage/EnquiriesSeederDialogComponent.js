...
import seederData from "./enquiries.seeder.json";
...
const EnquiriesSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(EnquiriesSeederDialogComponent);

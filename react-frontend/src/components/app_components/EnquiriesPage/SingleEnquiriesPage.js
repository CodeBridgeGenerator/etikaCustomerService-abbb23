...
const SingleEnquiriesPage = (props) => {
  ...
  const [isHelpSidebarVisible, setHelpSidebarVisible] = useState(false);
    ...
    useEffect(() => {
        ...
        client
            .service("enquiries")
            .get(urlParams.singleEnquiriesId, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
    ...
    }, [props,urlParams.singleEnquiriesId]);
    ...
    return (
        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-12">
                ...
                {/* <p>enquiries/{urlParams.singleEnquiriesId}</p> */}
            </div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Machine Quantity</label><p className="m-0 ml-3" >{Number(_entity?.machineQuantity)}</p></div>
      ...
      <CommentsSection
        recordId={urlParams.singleEnquiriesId}
        user={props.user}
        alert={props.alert}
...
export default connect(mapState, mapDispatch)(SingleEnquiriesPage);

...
import seederData from "./customerDetails.seeder.json";
...
const CustomerDetailsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(CustomerDetailsSeederDialogComponent);

...
import seederData from "./complaintTypes.seeder.json";
...
const ComplaintTypesSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(ComplaintTypesSeederDialogComponent);

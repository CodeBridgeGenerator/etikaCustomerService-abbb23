...
import seederData from "./rentals.seeder.json";
...
const RentalsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(RentalsSeederDialogComponent);

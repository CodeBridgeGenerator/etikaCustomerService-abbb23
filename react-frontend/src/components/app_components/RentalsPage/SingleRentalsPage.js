...
const SingleRentalsPage = (props) => {
  ...
  const [isHelpSidebarVisible, setHelpSidebarVisible] = useState(false);
    ...
    useEffect(() => {
        ...
        client
            .service("rentals")
            .get(urlParams.singleRentalsId, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
    ...
    }, [props,urlParams.singleRentalsId]);
    ...
    return (
        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-12">
                ...
                {/* <p>rentals/{urlParams.singleRentalsId}</p> */}
            </div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Email Address</label><p className="m-0 ml-3" >{_entity?.emailAddress}</p></div>
      ...
      <CommentsSection
        recordId={urlParams.singleRentalsId}
        user={props.user}
        alert={props.alert}
        serviceName="rentals"
      />
...
export default connect(mapState, mapDispatch)(SingleRentalsPage);

...
const RentalsEditDialogComponent = (props) => {
...
emailAddress: _entity?.emailAddress,
        ...
        await client.service("rentals").patch(_entity._id, _data);
        ...
        props.onHide();
        props.alert({ type: "success", title: "Edit info", message: "Info rentals updated successfully" });
    ...
    return (
        <Dialog header="Edit Rentals" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max scalein animation-ease-in-out animation-duration-1000" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto"
            style={{ maxWidth: "55vw" }} role="rentals-edit-dialog-component">
...
export default connect(mapState, mapDispatch)(RentalsEditDialogComponent);

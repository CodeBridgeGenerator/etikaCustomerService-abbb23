...
import seederData from "./bankDetails.seeder.json";
...
const BankDetailsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(BankDetailsSeederDialogComponent);

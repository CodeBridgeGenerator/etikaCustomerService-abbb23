...
const SingleRelocationsPage = (props) => {
  ...
  const [isHelpSidebarVisible, setHelpSidebarVisible] = useState(false);
    ...
    useEffect(() => {
        ...
        client
            .service("relocations")
            .get(urlParams.singleRelocationsId, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
    ...
    }, [props,urlParams.singleRelocationsId]);
        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-12">
                ...
                <div className="flex align-items-center">
                    ...
                    <h3 className="m-0">Relocations</h3>
                    <SplitButton
                ...
                {/* <p>relocations/{urlParams.singleRelocationsId}</p> */}
            </div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Relocation Reason</label><p className="m-0 ml-3" >{_entity?.relocationReason}</p></div>
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">New Outlet</label><p className="m-0 ml-3" >{_entity?.newOutlet}</p></div>
      ...
      <CommentsSection
        recordId={urlParams.singleRelocationsId}
        user={props.user}
        alert={props.alert}
...
export default connect(mapState, mapDispatch)(SingleRelocationsPage);

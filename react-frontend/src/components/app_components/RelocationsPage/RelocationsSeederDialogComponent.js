...
import seederData from "./relocations.seeder.json";
...
const RelocationsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(RelocationsSeederDialogComponent);

...
const TerminationsEditDialogComponent = (props) => {
...
additionalDetail: _entity?.additionalDetail,
        ...
        await client.service("terminations").patch(_entity._id, _data);
        ...
        props.onHide();
        props.alert({ type: "success", title: "Edit info", message: "Info terminations updated successfully" });
    ...
    return (
        <Dialog header="Edit Terminations" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max scalein animation-ease-in-out animation-duration-1000" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto"
            style={{ maxWidth: "55vw" }} role="terminations-edit-dialog-component">
...
export default connect(mapState, mapDispatch)(TerminationsEditDialogComponent);

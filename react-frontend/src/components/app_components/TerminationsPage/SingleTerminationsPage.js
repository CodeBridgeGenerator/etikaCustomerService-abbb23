...
const SingleTerminationsPage = (props) => {
  ...
  const [isHelpSidebarVisible, setHelpSidebarVisible] = useState(false);
    ...
    useEffect(() => {
        ...
        client
            ...
            .get(urlParams.singleTerminationsId, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
    ...
    }, [props,urlParams.singleTerminationsId]);
        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-12">
                ...
                <div className="flex align-items-center">
                    ...
                    <h3 className="m-0">Terminations</h3>
                    <SplitButton
                ...
                {/* <p>terminations/{urlParams.singleTerminationsId}</p> */}
            </div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Additional Detail</label><p className="m-0 ml-3" >{_entity?.additionalDetail}</p></div>
      ...
      <CommentsSection
        recordId={urlParams.singleTerminationsId}
        user={props.user}
        alert={props.alert}
...
export default connect(mapState, mapDispatch)(SingleTerminationsPage);

...
import seederData from "./terminations.seeder.json";
...
const TerminationsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(TerminationsSeederDialogComponent);

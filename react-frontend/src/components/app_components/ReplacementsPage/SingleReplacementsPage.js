...
const SingleReplacementsPage = (props) => {
  ...
  const [isHelpSidebarVisible, setHelpSidebarVisible] = useState(false);
    ...
    useEffect(() => {
        ...
        client
            ...
            .get(urlParams.singleReplacementsId, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
    ...
    }, [props,urlParams.singleReplacementsId]);
        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-12">
                ...
                <div className="flex align-items-center">
                    ...
                    <h3 className="m-0">Replacements</h3>
                    <SplitButton
                ...
                {/* <p>replacements/{urlParams.singleReplacementsId}</p> */}
            </div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Replacement Reason</label><p className="m-0 ml-3" >{_entity?.replacementReason}</p></div>
      ...
      <CommentsSection
        recordId={urlParams.singleReplacementsId}
        user={props.user}
        alert={props.alert}
...
export default connect(mapState, mapDispatch)(SingleReplacementsPage);

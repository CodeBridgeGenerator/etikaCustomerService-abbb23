...
const ReplacementsEditDialogComponent = (props) => {
...
replacementReason: _entity?.replacementReason,
        };

        setLoading(true);
        try {
            
        await client.service("replacements").patch(_entity._id, _data);
        ...
        props.onHide();
        props.alert({ type: "success", title: "Edit info", message: "Info replacements updated successfully" });
    ...
    return (
        <Dialog header="Edit Replacements" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max scalein animation-ease-in-out animation-duration-1000" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto"
            style={{ maxWidth: "55vw" }} role="replacements-edit-dialog-component">
...
export default connect(mapState, mapDispatch)(ReplacementsEditDialogComponent);

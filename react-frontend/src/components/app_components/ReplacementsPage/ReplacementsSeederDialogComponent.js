...
import seederData from "./replacements.seeder.json";
...
const ReplacementsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(ReplacementsSeederDialogComponent);

...
import seederData from "./agreements.seeder.json";
...
const AgreementsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(AgreementsSeederDialogComponent);

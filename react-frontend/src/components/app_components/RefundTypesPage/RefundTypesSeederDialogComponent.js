...
import seederData from "./refundTypes.seeder.json";
...
const RefundTypesSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(RefundTypesSeederDialogComponent);

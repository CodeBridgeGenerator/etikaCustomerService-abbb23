...
import seederData from "./vmCollections.seeder.json";
...
const VmCollectionsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(VmCollectionsSeederDialogComponent);

...
const VmCollectionsEditDialogComponent = (props) => {
...
collectionReason: _entity?.collectionReason,
        };

        setLoading(true);
        try {
            
        await client.service("vmCollections").patch(_entity._id, _data);
        ...
        props.onHide();
        props.alert({ type: "success", title: "Edit info", message: "Info vmCollections updated successfully" });
    ...
    return (
        <Dialog header="Edit Collections" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max scalein animation-ease-in-out animation-duration-1000" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto"
            style={{ maxWidth: "55vw" }} role="vmCollections-edit-dialog-component">
...
export default connect(mapState, mapDispatch)(VmCollectionsEditDialogComponent);

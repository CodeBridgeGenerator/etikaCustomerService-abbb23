const { Terminations } = require("./terminations.class");
const createModel = require("../../models/terminations.model");
const hooks = require("./terminations.hooks");
...
module.exports = function (app) {
  ...
  app.use("/terminations", new Terminations(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("terminations");

  // Get the schema of the collections 
  app.get("/terminationsSchema", function (request, response) {

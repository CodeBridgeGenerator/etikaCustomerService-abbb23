const { ComplaintTypes } = require("./complaintTypes.class");
const createModel = require("../../models/complaintTypes.model");
const hooks = require("./complaintTypes.hooks");
...
module.exports = function (app) {
  ...
  app.use("/complaintTypes", new ComplaintTypes(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("complaintTypes");

  // Get the schema of the collections 
  app.get("/complaintTypesSchema", function (request, response) {

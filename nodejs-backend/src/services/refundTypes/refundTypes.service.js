const { RefundTypes } = require("./refundTypes.class");
const createModel = require("../../models/refundTypes.model");
const hooks = require("./refundTypes.hooks");
...
module.exports = function (app) {
  ...
  app.use("/refundTypes", new RefundTypes(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("refundTypes");

  // Get the schema of the collections 
  app.get("/refundTypesSchema", function (request, response) {

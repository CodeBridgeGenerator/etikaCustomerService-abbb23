const { Relocations } = require("./relocations.class");
const createModel = require("../../models/relocations.model");
const hooks = require("./relocations.hooks");
...
module.exports = function (app) {
  ...
  app.use("/relocations", new Relocations(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("relocations");

  // Get the schema of the collections 
  app.get("/relocationsSchema", function (request, response) {

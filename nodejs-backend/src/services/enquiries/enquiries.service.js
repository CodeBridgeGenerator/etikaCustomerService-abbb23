const { Enquiries } = require("./enquiries.class");
const createModel = require("../../models/enquiries.model");
const hooks = require("./enquiries.hooks");
...
module.exports = function (app) {
  ...
  app.use("/enquiries", new Enquiries(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("enquiries");

  // Get the schema of the collections 
  app.get("/enquiriesSchema", function (request, response) {

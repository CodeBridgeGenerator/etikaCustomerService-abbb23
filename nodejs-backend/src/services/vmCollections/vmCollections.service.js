const { VmCollections } = require("./vmCollections.class");
const createModel = require("../../models/vmCollections.model");
const hooks = require("./vmCollections.hooks");
...
module.exports = function (app) {
  ...
  app.use("/vmCollections", new VmCollections(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("vmCollections");

  // Get the schema of the collections 
  app.get("/vmCollectionsSchema", function (request, response) {

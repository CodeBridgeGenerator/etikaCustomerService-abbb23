const { BankDetails } = require("./bankDetails.class");
const createModel = require("../../models/bankDetails.model");
const hooks = require("./bankDetails.hooks");
...
module.exports = function (app) {
  ...
  app.use("/bankDetails", new BankDetails(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("bankDetails");

  // Get the schema of the collections 
  app.get("/bankDetailsSchema", function (request, response) {

const { Replacements } = require("./replacements.class");
const createModel = require("../../models/replacements.model");
const hooks = require("./replacements.hooks");
...
module.exports = function (app) {
  ...
  app.use("/replacements", new Replacements(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("replacements");

  // Get the schema of the collections 
  app.get("/replacementsSchema", function (request, response) {

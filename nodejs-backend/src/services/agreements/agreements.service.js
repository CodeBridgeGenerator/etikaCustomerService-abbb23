const { Agreements } = require("./agreements.class");
const createModel = require("../../models/agreements.model");
const hooks = require("./agreements.hooks");
...
module.exports = function (app) {
  ...
  app.use("/agreements", new Agreements(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("agreements");

  // Get the schema of the collections 
  app.get("/agreementsSchema", function (request, response) {

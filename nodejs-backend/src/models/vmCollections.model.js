    ...
    module.exports = function (app) {
        const modelName = "vm_collections";
...
collectionReason: { type:  String , minLength: 2, index: true, trim: true, default: "", comment: "Collection Reason, p, false, true, true, true, true, true, true, , , , ," },

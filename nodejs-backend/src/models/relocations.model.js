...
relocationReason: { type:  String , minLength: 2, index: true, trim: true, default: "", comment: "Relocation Reason, p, false, true, true, true, true, true, true, , , , ," },
